...
from topology_benchmark.domains.polyhedral_nets.ports import PolyhedralAnswer
...
class IPolyhedralQuestion(IRegisteredQuestion, Protocol):
    attempts: int
...
class VertexPartitionQuestion(IPolyhedralQuestion):
    id = "vertex-partition"
...
class VertexDegreeQuestion(IPolyhedralQuestion):
    id = "vertex-degree"
...
class CurvatureOrderQuestion(IPolyhedralQuestion):
    id = "curvature-order"
...
class SeamMatchQuestion(IPolyhedralQuestion):
    id = "seam-match"
...
class CellDistanceQuestion(IPolyhedralQuestion):
    id = "cell-distance"
    count_paths = False
